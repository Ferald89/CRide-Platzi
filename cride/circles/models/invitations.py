...
class Invitation(CRideModel):
    ...
    a unique code that grants acess to specific circle.
    This codes are generaded by users that are already
    members of the circle and have a 'remaing_invitations'
