...
class InvitationsManagerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create(
            first_name='Pablo',
            last_name='Trinidad',
            email='pablotrinidad@cincias.unam.mx',
        ...
        self.circle = Circle.objects.create(
            ...
            slug_name='fciencias',
            about='Group oficial de la Facultad de Ciencias de la UNAM',
            verified=True
            )
